...
- **(Backend - Node.js):** You might need to configure your Stellar network details (Horizon server URL, network passphrase) in a separate configuration file for the Node.js backend. Refer to the Stellar documentation for details on setting up a Horizon server and network: [Stellar Documentation](https://developers.stellar.org/docs)
...
- **React Tutorial:** [React Documentation](https://legacy.reactjs.org/docs/getting-started.html)
- **Node.js and npm:** [Node.js](https://nodejs.org/en)
- **Stellar Javascript SDK:** [Stellar JS SDK](https://github.com/stellar/js-stellar-sdk)
- **Stellar Wallet Creation:** [Stellar Wallet Guide](https://developers.stellar.org/docs/build/apps/wallet/intro)
